...
data_ghia_u=np.loadtxt('re400u.txt')
data_ghia_v=np.loadtxt('re400v.txt')
...
pl.plot(u_fvm,y_fvm,'r-',linewidth=1.5,label=r'FVM $(\Delta x = 1/127)$')
...
pl.plot(x_fvm, v_fvm,'r-',linewidth=1.5,label=r'FVM $(\Delta x =1/127)$')
